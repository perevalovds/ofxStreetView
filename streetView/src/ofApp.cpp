...
void ofApp::draw(){
    ...
    if (b_drawPointCloud) {
        ...
        for(int i = 0; i < streetview.size(); i++){
            ...
            //distanceSpherical = ofxGeo::GeoUtils::distanceSpherical(home, newLocation);
            distanceHaversine = ofxGeo::GeoUtils::distanceHaversine(home, newLocation);
            bearingHaversine = ofxGeo::GeoUtils::bearingHaversine(home, newLocation);
            //midpoint = ofxGeo::GeoUtils::midpoint(home, newLocation);
